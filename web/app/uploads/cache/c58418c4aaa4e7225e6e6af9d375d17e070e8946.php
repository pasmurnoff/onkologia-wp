            ...
            <?php while($q->have_posts()): ?>
                ...
                <div class="feedback__item">
                    <div class="feedback__user">
                        <div class="user">
                            <div class="user__image">
                                <?php if($avatar_url): ?>
                                    <img src="<?php echo e(esc_url($avatar_url)); ?>" alt="<?php echo e(esc_attr($name)); ?>">
                                <?php else: ?>
                                    <div class="avatar-initial" style="background: <?php echo e($bg); ?>;" role="img"
                    ...
                    <div class="feedback__action">
                        <a href="#" class="btn_secondary js-open-feedback" data-id="<?php echo e($post_id); ?>"
                    ...
                    <script type="text/template" id="tmpl-feedback-item-<?php echo e($post_id); ?>">
          <div class="modal__user">
            <div class="image">
              <?php if($avatar_url): ?>
                <img src="<?php echo e(esc_url($avatar_url)); ?>" alt="<?php echo e(esc_attr($name)); ?>">
              <?php else: ?>
                <div class="avatar-initial" style="background: <?php echo e($bg); ?>;" role="img" aria-label="<?php echo e($name); ?>">
                  <?php echo e($initial); ?>
