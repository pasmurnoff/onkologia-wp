        ...
        <div class="header__inner">
            <div class="header__logo">
                <a href="/">
                    ...
                    <img src="<?= App\asset_path('images/logo.svg'); ?>" alt="logo" class="logo logo--light">
                    <img src="<?= App\asset_path('images/logo-dark.svg'); ?>" alt="logo" class="logo logo--dark">
                </a>
            </div>
            <div class="header__menu">
                <nav class="menu">
                    ...
                    <?php else: ?>
                        ...
                        <ul class="menu__list">
                            <li class="menu__item"><a class="menu__link" href="<?php echo e(home_url('/')); ?>">Главная</a></li>
                        </ul>
                    <?php endif; ?>
